//! Full credit to: https://github.com/Anders429/gba_test/blob/master/gba_test_macros/src/lib.rs
//! for the original source of this code, which has been changed for our purposes.
//! 
